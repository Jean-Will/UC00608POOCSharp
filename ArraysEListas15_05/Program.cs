namespace ArraysEListas15_05
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string[] diasDeVendas = { "Sex","Sab","Dom"};
            //float[] valoresDiarios = new float[3];
            ...
            //    totalSemanal += valoresDiarios[i];
            //    if (valoresDiarios[i] > melhorDia)
            //    {
            //        melhorDia = valoresDiarios[i];
            //    }
            //    //piorDia = valoresDiarios[0];

            //    if (valoresDiarios[i] < piorDia)
            //    {
            //        piorDia = valoresDiarios[i];
            //    }


            //    if (valoresDiarios[i] < (mediaSemana/2))
            //    {
            //        classificacao = "Dia Fraco";
            //    }
            //    else if (valoresDiarios[i] > (mediaSemana/2) && valoresDiarios[i] <(mediaSemana *3) )
            //    {
            //        classificacao = "Dia Normal";
            //    }
            //    else  
            //    {
            //        classificacao = "Dia Excelente";
            //    }



            //    mediaSemana = totalSemanal / valoresDiarios.Length;
            //}
            //for (int i = 0; i < diasDeVendas.Length; i++)
            //{
            //    Console.WriteLine($"Dias {diasDeVendas[i]} valor de venda diaria: {valoresDiarios[i]}\n");
            //}
            //Console.WriteLine($"Total Semanal: {totalSemanal}, media {mediaSemana} , melhor dia: {melhorDia}, pior dia: {piorDia}\n");
